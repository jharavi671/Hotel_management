...
import StarRating from '../components/StarRating';  // Adjust import path as needed
...
const RoomDetails = () => {
  ...
  if (!room) return <p className="py-28 px-4">Loading room details...</p>;

  return (
    <div className="py-28 md:py-32 px-4 md:px-16 lg:px-24">
      {/* Room Details */}
      ...
      <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
        ...
        <button type="submit" className="bg-orange-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-orange-600 transition duration-200">
          Check Availability
        </button>
      </form>
      ...
      <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
        <p>
          ...
          You get a comfortable Two bedroom apartment that has a true city feeling. The
          price quoted is for two guests. Please mark the number of
          guests to get the exact price for groups. Guests will be allocated
          ground floor according to availability. You get the comfortable two-bedroom
          apartment that has a true city feeling. The price quoted is for two guests.
        </p>
      </div>
