...
import searchIcon from '../assets/searchIcon.svg'; // Assuming you have this
// Sample city list
// const cities = ['New York', 'London', 'Paris', 'Tokyo'];
import { cities } from '../assets/assets'; // Importing the cities array from assets.js
...
const Hero = () => {
  return (
    <div className="flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white h-screen bg-[url('src/assets/heroImage.png')] bg-cover bg-center bg-no-repeat">
      ...
      <form className="bg-white text-gray-500 rounded-lg px-6 py-4 mt-10  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto mt-6">
        <div>
          <div className="flex items-center gap-2">
            <img src={calenderIcon} alt="calendar" className="h-4" />
