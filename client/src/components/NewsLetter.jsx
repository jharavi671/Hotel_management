...
const NewsLetter = () => {
  return (
 <div  className="f1ex flex-col items-center max-w-5x1 lg:w-full rounded-2x1 px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white" >    
            <Title title="Stay Inspired" subTitle=" JJoin our newsletter and be the first to discover new destinations, exclusive offers, and travel inspiration." />
